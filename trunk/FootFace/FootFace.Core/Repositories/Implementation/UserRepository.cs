...
{
    public class UserRepository : RepositoryBase<FootFaceDbContext, User>, IUserRepository
    {
        ...
        public bool ChangePassword(int userId, string newPassword)
        {
            ...
            {
                using (var dbContext = RepositoryBase<FootFaceDbContext, User>.CreateDbContext())
                {
