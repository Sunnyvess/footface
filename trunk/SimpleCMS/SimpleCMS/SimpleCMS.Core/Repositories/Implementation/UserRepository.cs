...
using SimpleCMS.Core.Infrastructure.Extensions;

namespace SimpleCMS.Core.Repositories.Implementation
{
    public class UserRepository : RepositoryBase<SimpleCMSDbContext, User>, IUserRepository
    {
        ...
        public bool ChangePassword(int userId, string newPassword)
        {
            ...
            {
                using (var dbContext = RepositoryBase<SimpleCMSDbContext, User>.CreateDbContext())
                {
